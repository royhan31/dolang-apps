					...
					<div class="row">
						...
						<div class="col-lg-5">
							<div class="demo-image">
								<img src="{{ asset('assets/images/samples/Mac.png')}}" alt="image"/>
							</div>
						</div>
					</div>
				</div>
		...
		<footer class="container-fluid footer">
			<div class="row pb-5 text-white footer-top">
				<div class="col-md-8 mx-auto">
					<div class="row">
						<div class="col-md-3">
							<img src="../../images/logo-white.svg" class="brand-logo" alt="image"/>
						...
						<div class="col-md-6">
							<div class="row contact-details">
								...
								<div class="col-12 d-flex mb-3">
									...
									<h6 class="font-weight-normal">support@Pearl.org</h6>
								</div>
							</div>
							<ul class="nav mt-3">
								<li class="nav-item">
